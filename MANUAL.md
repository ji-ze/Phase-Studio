...
Configure their executable paths in **Basic → Paths** if the defaults do not match your installation.
...
Phase Studio can request selected Superflip outputs, including:

- XPLOR maps,
- CCP4 maps,
- Jana m80/m81 outputs,
- standardized HKL exports.

XPLOR output is important for workflows that continue through SharpED or EDMA.
...
The **Basic → SharpED** page defines server connection and inference settings.
...
- Superflip XPLOR maps,
- optional CCP4 maps,
- Jana m80/m81 outputs,
- standardized HKL exports,
- Superflip logs,
- EDMA CIF/XYZ/PDB outputs,
- SharpED-processed XPLOR maps,
- symmetry-averaged processed maps,
- per-cycle models,
- metrics files,
- Jana2020 export data.
...
Check the executable paths in **Basic → Paths**.
